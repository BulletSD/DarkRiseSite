...
// Подключаем конфигурацию шаблона
...
<body id="page" class="page <?php echo $this['config']->get('body_classes'); ?>" data-config='<?php echo $this['config']->get('body_config', '{}'); ?>'>
	...
	<!-- Верхний тулбар: дата и произвольные модули слева/справа -->
	...
	<!-- Шапка сайта: логотип, меню, баннер -->
	...
	<!-- Основной контент: верхние секции, контент + сайдбары, нижние секции -->
